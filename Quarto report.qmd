...
concepts.
Blood pressure is measured in millimetres of mercury and is the
...
mental status, lethargy, somnolence and it an extreme situation even coma and 
poor renal blood flow can cause renal failure. On the other hand,high blood 
blood pressure can cause organ damage, for example, it can cause a heart attack,
stroke, hypertensive renal failure and retinopathy (1). Such is the importance 
of having an adecuate blood pressure.
...
Disease Control and Prevention (1) and the reference weight was calculated
using Calculators.org (2). The analysis was done in R and RStudio.
...
ggplot(aes(x= time))+
 ...
 labs( title = "Weight measurements of one young adult that works out 4 
       times a week",
       caption = "The vertical line shows the highest weight measurement
       and the horizontal line the ideal reference value",
       x= "Time",
       y= "Weight(kg)")+
 theme_bw()+
 theme(axis.text.x= element_text( size= "5"))
...
2. High Blood Pressure Symptoms, Causes, and Problems \| cdc.gov.
(2023, August 29). Centers for Disease Control and Prevention.
https://www.cdc.gov/bloodpressure/about.htm

3. How much should I weigh? Ideal body weight calculator for women & men*. 
