...
The reference values of blood pressure were obtained from the Center for Disease Control and Prevention (1) and the reference weight was calculated using Calculators.org. The analysis was done in R and RStudio.
...
# First hypothesis-----------------------------------------------------------------
#         H0; mean_sp = population_ps_mean
#         H1; mean_sp is different than population_ps_mean
...
# H0: mean_sp = ps_mean_pop; 109.5625= 120
# H1: mean_sp < ps_mean_pop; 109.5625 < 120
...
dp_mean <- mean(pd_analysis$dp)
dp_mean

dp_reference <- 80
dp_reference

standard_deviation_dp <- sd(pd_analysis$dp)
...
# First hypothesis-----------------------------------------------------------------
#         H0; dp_mean = pd_reference
#         H1; dp_mean is different than pd_reference
...
# p(Z<-22.59)=P(z> 22.59)= 1-p(Z<22.59)= pval_dp
# Since its a one tail, the pval is the same as pval_dp :

pval_one_side_dp <- pval_dp
pval_one_side_dp
...
#  H0: weight_mean = Reference_weight
#  H1: weight_mean is different than Reference_weight
#  alpha= 0.05
# Calculating the pivot: 
