...
The goal of this project is to do a comparison between the parameters of one young adult that exercises four times a week versus the average parameters of a healthy young adult.

Material and methods

In order to see whats the ideal weight the calculator from the website <https://www.calculators.org/health/ideal-weight.php> was used.

To verify what are the reference values for a healthy person, to verify the reference values of blood pressure the website <https://www.cdc.gov/bloodpressure/about.htm> was used. 

To properly measure the BP the guidelines on the website <https://www.cdc.gov/bloodpressure/measure.htm> were followed.

The reference values of pulse rate were obtained from the website <https://www.bhf.org.uk/informationsupport/heart-matters-magazine/medical/ask-the-experts/pulse-rate>.

In order to make the analysis, R and RStudio were used.
...
# First hypothesis:   H0; mean_ps=population_ps_mean
...
#of this young adult that workout 4 times a week is different than the mean reference diastolic pressure of a healthy young adult.
...
#
# 1. 1. Calculating the 95% CI ----------------------------------------------------

# With the CI we have already demonstrated that it is below, since it doesnt include H0

# 2. Rejection are method---------------------------------------------------------- 
#since out pivot is -22.59 it falls within the rejection region , therefore we still reject H0 and we accept H1, the diastolic pressure of this young adult that works out 4 times a week is less than the average pressure value of a healthy young adult. 

# 3. Calculating the p-value-------------------------------------------------------

# p(Z<-22.59)=P(z> 22.59)= 1-p(Z<22.59)= pval_pd
# Since its a once tail the pval is the same as pval_pd :
