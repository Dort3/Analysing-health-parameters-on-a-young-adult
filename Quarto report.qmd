...
This project was the result of considering how I could improve my R programming skilsl as well as practising some basic statistics, the solution was to practise with a dataset, so I created my own dataset by measuring some health parameters that could easily be measured at home, I took a total of 16 observations of my blood pressure , my heart rate (although this variable was not used int he analysis) and my weight.
