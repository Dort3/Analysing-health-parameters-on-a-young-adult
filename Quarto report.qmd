...
# We will call raw_data the file location that we got from file.choose(), we add everything we see in the console after using the function.
raw_data <- " Excel file location"
